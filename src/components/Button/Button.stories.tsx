...
stories.add(
  ...
  () => {
    ...
    const buttonIcon = select('Icon Position', {left: 'left', right: 'right', 'no icon': null}, null);
...
stories.add('Main', () => <div>
    <div style={{padding: '10px 0'}}>
      <Button type="main" label="Main Button" onClick={action('main button clicked')}/>
    </div>

    <div style={{padding: '10px 0'}}>
      <Button type="main" label="Main Button Disabled" disabled onClick={action('main button clicked')}/>
    </div>

    <div style={{padding: '10px 0'}}>
      <Button type="main" label="Main Button" iconPosition="left" onClick={action('main button clicked')}/>
    </div>

    <div style={{padding: '10px 0'}}>
      <Button type="main" label="Main Button" iconPosition="right" onClick={action('main button clicked')}/>
    </div>

    <div style={{padding: '10px 0'}}>
      <Button type="main" size="small" label="Small CTA" onClick={action('main button clicked')}/>
    </div>
...
stories.add('Secondary', () => <div>
    ...
    <div style={{ padding: '10px 0' }}>
      <Button type="secondary" size="small" label="Small Icon Left" iconPosition="left" />
    </div>
